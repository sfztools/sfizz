...
auto* const view__33 = createLogicalGroup(CRect(5, 110, 796, 395), -1, "", kCenterText, 14);
subPanels_[kPanelInfo] = view__33;
view__0->addView(view__33);
view__33->setVisible(false);
auto* const view__34 = createRoundedGroup(CRect(0, 0, 790, 280), -1, "", kCenterText, 14);
...
auto* const view__48 = createLogicalGroup(CRect(5, 109, 795, 425), -1, "", kCenterText, 14);
subPanels_[kPanelSettings] = view__48;
view__0->addView(view__48);
auto* const view__49 = createTitleGroup(CRect(300, 26, 495, 126), -1, "Engine", kCenterText, 12);
...
auto* const view__54 = createTitleGroup(CRect(170, 161, 585, 261), -1, "Tuning", kCenterText, 12);
...
auto* const view__65 = createTitleGroup(CRect(615, 161, 754, 261), -1, "Files", kCenterText, 12);
...
auto* const view__68 = createTitleGroup(CRect(525, 26, 720, 126), -1, "Quality", kCenterText, 12);
...
auto* const view__73 = createTitleGroup(CRect(35, 161, 140, 261), -1, "Appearance", kCenterText, 12);
...
auto* const view__77 = createLogicalGroup(CRect(25, 130, 816, 415), -1, "", kCenterText, 14);
