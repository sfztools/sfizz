...
auto* const view__4 = createSfizzMainButton(CRect(30, 5, 150, 65), kTagAbout, "", kCenterText, 14);
...
auto* const view__66 = createPiano(CRect(5, 400, 795, 470), -1, "", kCenterText, 12);
piano_ = view__66;
view__0->addView(view__66);
