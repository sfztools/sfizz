...
auto* const view__12 = createLabel(CRect(10, 40, 370, 70), -1, "Key switch:", kLeftText, 20);
keyswitchLabel_ = view__12;
view__8->addView(view__12);
auto* const view__13 = createLabel(CRect(10, 73, 70, 98), -1, "Voices:", kRightText, 12);
view__8->addView(view__13);
auto* const view__14 = createPreviousFileButton(CRect(295, 13, 320, 38), kTagPreviousSfzFile, "", kCenterText, 24);
view__8->addView(view__14);
auto* const view__15 = createNextFileButton(CRect(320, 13, 345, 38), kTagNextSfzFile, "", kCenterText, 24);
view__8->addView(view__15);
auto* const view__16 = createChevronDropDown(CRect(345, 13, 370, 38), kTagFileOperations, "", kCenterText, 24);
fileOperationsMenu_ = view__16;
view__8->addView(view__16);
auto* const view__17 = createLabel(CRect(75, 73, 115, 98), -1, "", kCenterText, 12);
infoVoicesLabel_ = view__17;
view__8->addView(view__17);
auto* const view__18 = createLabel(CRect(130, 73, 170, 98), -1, "Max:", kRightText, 12);
view__8->addView(view__18);
auto* const view__19 = createLabel(CRect(175, 73, 210, 98), -1, "", kCenterText, 12);
numVoicesLabel_ = view__19;
view__8->addView(view__19);
auto* const view__20 = createLabel(CRect(240, 73, 300, 98), -1, "Memory:", kRightText, 12);
view__8->addView(view__20);
auto* const view__21 = createLabel(CRect(305, 73, 365, 98), -1, "", kCenterText, 12);
memoryLabel_ = view__21;
view__8->addView(view__21);
auto* const view__22 = createChevronValueDropDown(CRect(210, 77, 230, 97), kTagSetNumVoices, "", kCenterText, 16);
